...
namespace ReactorWaste{													// Add/replace your reactor subtype IDs here
	...
	[MyEntityComponentDescriptor(typeof(MyObjectBuilder_Reactor), false, "LargeBlockLargeGenerator2x","SmallBlockLargeGenerator2x","LargeBlockSmallGenerator2x","SmallBlockSmallGenerator2x","LargeBlockLargeGenerator4x","SmallBlockLargeGenerator4x","LargeBlockSmallGenerator4x","SmallBlockSmallGenerator4x","LargeBlockLargeGenerator8x","SmallBlockLargeGenerator8x","LargeBlockSmallGenerator8x","SmallBlockSmallGenerator8x")]
	public class ReactorWaste : MyGameLogicComponent{
		...
		public float WasteMultiplier = 0.75f; // Ratio of Waste produced to Fuel consumed
